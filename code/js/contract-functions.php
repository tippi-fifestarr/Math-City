<script>
		...
		//var verifierAddress = '0xbb43CbD8B139483286a8772D9D289bF85CB4c148';
		...
		async function createGame(){
			...
			// Construct circuit, save proof bytes32, build verifier, deploy verifier, save address in gameContract
			

			// Read address in GameContract, call verify
		...
		async function submitGuess(){
			let web3 = new Web3(Web3.givenProvider);
			var contract = new web3.eth.Contract(abi1, gameContractAddress, {});
			//var verifierContract = new web3.eth.Contract(abi2, verifierAddress, {});
